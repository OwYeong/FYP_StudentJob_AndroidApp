...
public class StudentChatSearchRecylerViewAdapter extends RecyclerView.Adapter<StudentChatSearchRecylerViewAdapter.MyViewHolder> {
    ...
    public StudentChatSearchRecylerViewAdapter(Context myContext, Fragment parentFragment, ArrayList<ChatRoomUserInfo> chatRoomSearchedArrayList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int position) {
        ...
        myViewHolder.bigContainer_linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((FragmentStudentMessagepage)parentFragment).emptySearchBarText();
                ...
                currentActivity.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (currentLayoutName.equals("StudentMessagepage")) {
                            ...
                            if(StudentMessagepage.getChatRoomInfoWithOpponentUsername(currentSearchedChatUserInfo.getUsername()) != null){
                                FragmentStudentChatroompage.setSelectedChatRoomInfo(StudentMessagepage.getChatRoomInfoWithOpponentUsername(currentSearchedChatUserInfo.getUsername()));
                            }else{
                                //new chat room
                            ...
                            ((StudentMessagepage)currentActivity).changeFragmentPage(chatRoomPageFragment, "chatRoomPageFragment",null);
