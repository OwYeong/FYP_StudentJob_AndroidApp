...
public class FragmentStudentCheckPortfolio extends Fragment {
    ...
    private View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                case R.id.fragment_student_check_portfoliopage_contentContainer_urlNavigate_btn:
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View layout = inflater.inflate(R.layout.fragment_student_check_portfoliopage, container, false);

        portfolioNavigateBtn_button = (Button) layout.findViewById(R.id.fragment_student_check_portfoliopage_contentContainer_urlNavigate_btn);

        studentName_textView = (TextView) layout.findViewById(R.id.fragment_student_check_portfoliopage_headerContainer_name);
        studentGeneralSkillCategory_textView = (TextView) layout.findViewById(R.id.fragment_student_check_portfoliopage_headerContainer_generalSkillCategory);
        studentPortfolioDesc_textView = (TextView) layout.findViewById(R.id.fragment_student_check_portfoliopage_contentContainer_portfolioDesc);

        studentPortfolioPic_imageView =(ImageView) layout.findViewById(R.id.fragment_student_check_portfoliopage_contentContainer_portfolioPic);
