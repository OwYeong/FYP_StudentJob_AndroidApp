...
public class StudentChatMessageRecyclerViewAdapter extends RecyclerView.Adapter {
    ...
    public StudentChatMessageRecyclerViewAdapter(Context myContext, Fragment parentFragment, ArrayList<ChatMessage> chatMessageArrayList, Bitmap oppenentProfilePic) {
    ...
    public int getItemViewType(int position) {
        ...
        if (currentChatMessage.getFrom().equals(ApplicationManager.getMyStudentAccountInfo().getUsername())) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder myViewHolder, int position) {
        ...
        switch (myViewHolder.getItemViewType()) {
            case VIEW_TYPE_MESSAGE_SENT:
                ((SentMessageHolder) myViewHolder).bind(currentMessage);
                break;
            case VIEW_TYPE_MESSAGE_RECEIVED:
                ((ReceivedMessageHolder) myViewHolder).bind(currentMessage);
        }
    }
