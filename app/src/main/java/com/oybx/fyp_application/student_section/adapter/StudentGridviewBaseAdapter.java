...
public class StudentGridviewBaseAdapter extends BaseAdapter {

    private Context mContext;
    private ArrayList<StudentPortfolioInfo> studentPortfolioInfoArrayList = new ArrayList<>();

    public StudentGridviewBaseAdapter(Context mContext, ArrayList<StudentPortfolioInfo> studentPortfolioInfoArrayList){
