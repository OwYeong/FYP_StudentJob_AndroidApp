...
public class FragmentEmployerRequestpage extends Fragment {

    private final String TAG = "Fragment-emprequestpage";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View layout = inflater.inflate(R.layout.fragment_employer_requestpage, container, false);
    ...
    private void setupViewPagerAndTab(){
        ...
        myFragmentViewPager = (((EmployerRequestpage) getActivity()).findViewById(R.id.fragment_emp_requestpage_fragment_container));
        myTabLayout = (((EmployerRequestpage) getActivity()).findViewById(R.id.fragment_emp_requestpage_tab));


        //setup fragment adapter first
        // note: add all fragment page in EmployerHomepage into the adapter , Fragment title is added for setting it into the tab name
        myFragmentAdapter.addFragment(new NestedFragmentEmployerMyRequest(), "My Request");
        myFragmentAdapter.addFragment(new NestedFragmentEmployerHistory(), "My History");
