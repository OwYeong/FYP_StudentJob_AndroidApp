...
public class LoginPage extends AppCompatActivity {
        ...
        public void onClick(final View v) {
            switch(v.getId()){
                case R.id.login_id_btn:
                    ...
                    loginGstBtn.setEnabled(false);//disable another btn will be enable after transition done
                    ...
                    break;
                case R.id.login_gst_btn:
                    Log.i(TAG, "transition lock is " + transitionLock);
                    loginIdBtn.setEnabled(false);//disable another btn will be enable after transition done
                    if(!transitionLock)// if transition lock is false
                        Log.i(TAG, "GST btn");
                        chgLayout((Button) v, "guest");// animate the button and change layout after the animation end
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginGstBtn = (Button) findViewById(R.id.login_gst_btn);
        loginBtn = (Button) findViewById(R.id.login_id);

        loginIdBtn.setOnClickListener(onClickListener);
        loginGstBtn.setOnClickListener(onClickListener);
    ...
    protected void onStart(){
        ...
        // Post() will be called whemn the height is ready, it allow the height to be taken.
