...
public class ComObject implements Serializable {
    ...
    public ComObject(String type, String title, String[] relatedStringContent, Table[] relatedTableContent, Query[] relatedQueryContent) {
        //Used to construct Communication ComObject Which have all type of Related content
        this.type = type;
        this.title = title;
    ...
    public ComObject(String type, String title, String[] relatedStringContent){
        //Used to construct Communication ComObject Which have only type of String Related content
        this.type = type;
        this.title = title;
        this.relatedStringContent = relatedStringContent;
    }
    ...
    public ComObject(String type, String title, Table[] relatedTableContent){
        //Used to construct Communication ComObject Which have only type of Table Related content
        this.type = type;
        this.title = title;
        this.relatedTableContent = relatedTableContent;
    ...
    public ComObject(String type, String title, Query[] relatedQueryContent){
        //Used to construct Communication ComObject Which have only type of Query Related content
        this.type = type;
        this.title = title;
        this.relatedQueryContent = relatedQueryContent;
    ...
    public ComObject(String type, String title, String[] relatedStringContent, Table[] relatedTableContent){
        //Used to construct Communication ComObject Which have two type of Related content -> string and Table
        this.type = type;
        this.title = title;
        this.relatedStringContent = relatedStringContent;
        this.relatedTableContent = relatedTableContent;
    ...
    public ComObject(String type, String title, String[] relatedStringContent, Query[] relatedQueryContent){
        //Used to construct Communication ComObject Which have two type of Related content -> string and Query
        this.type = type;
        this.title = title;
        this.relatedStringContent = relatedStringContent;
        this.relatedQueryContent = relatedQueryContent;
    ...
    /**SECTION END : ComObject Constructor*/

    /**SECTION : ComObject Getter*/
